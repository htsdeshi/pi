...
image = Image.new("1", (16, 32)) # Can be larger than matrix if wanted!!
...
for n in range(-16, 33): # Start off top-left, move off bottom-right
	matrix.Clear()
...
for n in range(16, -image.size[0], -1): # Scroll R to L
